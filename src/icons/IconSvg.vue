<template>
  <div class="flex items-center gap-4">
    <!-- <div @click="goToIg" class="social-button">
      <button class="relative w-10 h-10 rounded-full group">
        <div
          class="floater w-full h-full absolute top-0 left-0 bg-pink-400 rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"
        ></div>
        <div
          class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-pink-400 rounded-full"
        >
          <svg
    ...
    <div @click="goToGithub" class="social-button">
      <button class="relative w-10 h-10 rounded-full group">
        <div
          class="floater w-full h-full absolute top-0 left-0 bg-white rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"
        ></div>
        <div
          class="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-white rounded-full"
        >
          <svg height="24" width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
              class="group-hover:fill-[#ffffff] fill-primary duration-300"
...
<script setup>
const goToGithub = () => {
  window.open('https://github.com/MUHAMADTEGARWIJAYA', '_blank')
}
</script>
