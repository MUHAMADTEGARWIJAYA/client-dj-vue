<template>
  ...
  >
    ...
    >
      <router-link
        to="/"
        :class="{ 'text-hover bg-[#ff6a6ab3] rounded-xl font-bold': route.path === '/' }"
        class="group relative px-3 cursor-pointer"
      >
        <div
          class="flex h-10 w-10 items-center justify-center rounded-lg hover:text-hover transition-colors duration-300"
        >
          <img
            src="/nintendo-switch.svg"
            alt=""
            class="group-hover:scale-110 p-1 transition-transform duration-300"
          />
        </div>
        <span
      ...
      <router-link
        to="/ps2"
        :class="{ 'text-hover bg-[#a9bed0] rounded-xl font-bold': route.path === '/ps2' }"
        class="group relative px-3 cursor-pointer"
      >
        <div
          class="flex h-10 w-10 items-center justify-center rounded-lg hover:text-hover transition-colors duration-300"
      ...
      <!-- <router-link
        to="/settings"
        :class="{ 'text-hover font-bold': route.path === '/settings' }"
        class="group relative px-3 cursor-pointer"
      >
        <div
          class="flex h-10 w-10 items-center justify-center rounded-lg hover:bg-blue-50 hover:text-hover transition-colors duration-300"
        >
          <svg
            class="group-hover:scale-110 transition-transform duration-300"
            width="20"
